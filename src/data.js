...
export const catalogSections = [
  ...
  },
  {
    ...
    links: [
      ["Фронтальные погрузчики", "/catalog?category=loaders"],
      ["Телескопические погрузчики", "/catalog?category=loaders"],
      ["Мини-погрузчики", "/catalog?category=loaders"],
    ],
  ...
  },
  {
    ...
    links: [
      ["Грунтовые катки", "/catalog?category=road"],
      ["Дорожные фрезы", "/catalog?category=road"],
      ["Асфальтоукладчики", "/catalog?category=road"],
    ],
